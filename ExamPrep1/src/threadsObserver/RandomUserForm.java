 ...
 */
public class RandomUserForm extends javax.swing.JFrame implements UserObserver {
  ...
  private void btn1Clicked(java.awt.event.ActionEvent evt) {                             

      RandomUserControl randomUserControl = new RandomUserControl();
      randomUserControl.registerObserver(this);
      randomUserControl.start();
...
//    textEmail.setText(random.getEmail());
  ...
  // End of variables declaration                   
    ...
    @Override
    public void dataready(RandomUser random) {
        textFirstName.setText(random.getFirstName());
        textLastName.setText(random.getLastName());
        textStreet.setText(random.getStreet());
        textCity.setText(random.getCity());
